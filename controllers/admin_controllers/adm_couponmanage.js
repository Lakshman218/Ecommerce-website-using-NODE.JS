...
module.exports.postCoupon = async(req,res) => {
  ...
  const { couponCode, description, discountAmount, minimumPurchase, expiryDate, status } = req.body
  ...
  } else if ( !couponCode || !description || !discountAmount || !minimumPurchase || !expiryDate || !status ) {
...
module.exports.postEditcoupon = async(req,res) => {
  try{
    ...
    const { couponId, couponCode, description, discountAmount, minimumPurchase, expiryDate, status } = req.body
